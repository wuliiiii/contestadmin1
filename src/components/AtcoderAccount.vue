<template>
  <div class="container">
    <el-table :data="data">
      ...
      <el-table-column prop="atcoderId" label="用户名" fixed align="center">
      </el-table-column>
  ...
  <AddAtcoderAccount ref="formRef"></AddAtcoderAccount>
</template>
...
import AddAtcoderAccount from "./ApplicationComponents/AddAtcoderAccount.vue";
...
let setMain = (id)=>{
  axiosUtil.atcoderAPI.setMainAtcoder(id).then(res=>{
    if(res.data.code === 200){
